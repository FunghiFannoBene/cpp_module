...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/02 23:56:59 by shhuang           #+#    #+#             */
/*   Updated: 2024/01/02 23:57:00 by shhuang          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ScavTrap.hpp"

ScavTrap::ScavTrap(): ClapTrap("base name" ,100, 50, 20)
{
...
ScavTrap::~ScavTrap()
{
	std::cout << "Ho distrutto un SCAVTRAP!\n";
}
